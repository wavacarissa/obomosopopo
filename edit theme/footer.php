    <!-- start footer -->
        ...
        <footer id="footer" class="footer-wrap"> 
            <section style="background-color: #073C64;" class="kc-elm kc-css-784752 kc_row">
                                    ...
                                    <div class="kc-elm kc-css-258437 kc_col-sm-4 kc_column_inner kc_col-sm-4">
                                        <div class="kc_wrapper kc-col-inner-container">
                                            <div class="kc-elm kc-css-655434 kc_shortcode kc_single_image">
                                                <img src="http://localhost/wordpress/wp-content/plugins/kingcomposer/assets/images/get_start.jpg" class="" alt=""> </div>
